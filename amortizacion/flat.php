...
<head>
	...
	<title>Sistema Flat - Sistema de amortizaciones e intereses constante</title>
	<link rel="stylesheet" href="css/style.css" type="text/css">
</head>

<body>
	<header>
		<h1 class="flat">SISTEMA FLAT</h1>
        ...
        <table id="lista-tabla" class="tabla">
            <thead>
                <tr>
                    ...
                    <th class="amortizacion" title="2. En esta columna se mostrará el resultado constante del 'PRESTAMO' entre la cantidad total de 'PERIODOS'.">AMORTIZACIÓN</th>
                    <th title="4. En esta columna se mostrará el resultado del 'SALDO' anterior menos la 'AMORTIZACIÓN'.">SALDO</th>
                </tr>
            </thead>
            <tbody></tbody>
        </table><br>
    <script src="js/amortizacionFlat.js"></script><br>
