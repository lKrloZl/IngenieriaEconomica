...
<head>
	...
	<title>Sistema Alemán - Sistema de Amortizaciones constantes</title>
	<link rel="stylesheet" href="css/style.css" type="text/css">
</head>

<body>
	<header>
		<h1 class="alemania">SISTEMA ALEMÁN</h1>
        <h2>SISTEMA DE AMORTIZACIONES CONSTANTES</h2>
	</header>
	<main>
        ...
        <table id="lista-tabla" class="tabla">
            <thead>
                <tr>
                    ...
                    <th title="3. En esta columna se mostrará el resultado del 'INTERÉS' más el 'INTERÉS'.">RENTA</th>
                    <th title="2. En esta columna se mostrará el resultado de la 'TASA EFECTIVA' más el 'SALDO' del periodo anterior.">INTERÉS</th>
                    <th class="amortizacion" title="1. En esta columna se mostrará el resultado constante del 'SALDO' entre la cantidad total de 'PERIODOS'.">AMORTIZACIÓN</th>
                    <th title="4. En esta columna se mostrará el resultado del 'SALDO' anterior menos la 'AMORTIZACIÓN'.">SALDO</th>
                </tr>
            </thead>
            <tbody></tbody>
        </table><br>
    <script src="js/amortizacionAleman.js"></script><br>
